...
::: {style="font-size: 75%;"}
[Download presentation as pdf](Introduction.R.lecture1..pdf)
:::
:::
...
3. Subset vec1 to only elements 4 through 6. Call this new object 'vec1a'.
4. Create a new vector (length 3) of characters called "hab1", "hab2", and "hab3". Call this object 'vec2'.
5. Put vec1a and vec2 together into a data frame and call this object 'dat'
