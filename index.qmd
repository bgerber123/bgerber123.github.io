...
-   **HW**: Simulate your own occupancy study for a disease causing prion! Create a sampling grid like we did in class but:
  
    -   Consider it a common species (concentrated instead of dispersed)
    -   Run both a large and small home range
    -   Use small and large grid sizes
    -   Compare these scenarios as well as what we’ve seen in class
    -   What type of sampling should we use to most effectively understand this outbreak?
...
-   Assigned Reading: <a href="/Week 11/Does Lack of Knowledge Lead to Misperceptions.pdf">Assigned Reading</a> and <a href="/Week 11/Discussion Questions.docx">Discussuion Questions</a>.
