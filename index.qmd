...
-   Install R packages:
```{r, eval=FALSE, echo=TRUE}
install.packages(c("rjags","bayesplot"))
```
...
-   Date Download: <a href="/Week 7/counts.trees1.csv">Data Set 1</a>, and <a href="/Week 7/counts.trees2.csv">Data Set 1</a>
...
Student Designed Class 1

### Week 13

Student Designed Class 2

### Week 14

Student Designed Class 3
