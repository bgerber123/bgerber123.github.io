...
#########################################
# If you multiply two matrices together, you should know the dimensions of the output matrix
...
# are called partial intercepts or dummy codes to indicate the different levels.
...
#here, we reassign which is the "reference" category 
