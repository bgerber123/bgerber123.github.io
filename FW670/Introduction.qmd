...
[* more on the main site](index.html#tab-proj)
...
## [How to use generative AI?]{style="color:#078BCD;"}
...
::: incremental
-   Learning is a choice, in each movement
...
{js, echo=FALSE} window.addEventListener('hashchange', function() { var hash = window.location.hash; if (hash) { var tabTrigger = document.querySelector('button[data-bs-target="' + hash + '"], a[href="' + hash + '"]'); if (tabTrigger) { var tab = new bootstrap.Tab(tabTrigger); tab.show(); } } });
