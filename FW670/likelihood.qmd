...
## The pieces
  ...
  -   A probability function for $\textbf{y}$:
      ...
      -   $f(\textbf{y}|\theta)$ or $f(\textbf{y};\theta)$ or $[\textbf{y}|\theta]$ or $P(\textbf{y}|\theta)$
...
$$
\begin{align*}
\mathcal{L}(\boldsymbol{\theta}|y) = f(y|\boldsymbol{\theta})
\end{align*}
$$
...
- MLEs are <span style="color:red">consistent</span>. As sample size increases, they will converge towards (get closer) the true parameter value.
