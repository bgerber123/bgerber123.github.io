...
- **When**: Mo 11am - 12:15pm and Fr 10am - 1pm
...
[* more on the main site (5th tab)](index.qmd#tab-proj)
...
![R and RStudio logos](/img/logosR.png){#fig-R-RStudio-logos}
...
## [How do you use generative AI?]{style="color:#078BCD;"}
...
![XY visualization of students and knowledge](/img/learning.graph.png){fig-align="center" width=50%}


:::: {style="text-align: center;"}

[I do not know where you are starting]{style="color:red;"}
...
::: {.r-stack}
![Extremes of how and what models get fit](/img/modeling.knowledge0.png){.fragment height="580"}

![Extremes of how and what models get fit full](/img/modeling.knowledge.png){.fragment height="580"}
:::
...
![Brian doing fieldwork](/img/me.png)

## [My Background]{style="color:#078BCD"}

![Contributing to workshops](/img/me2.png)
...
## [Course Website]{style="color:#078BCD"}

- **Lectures, code, readings, schedule, etc.**
  - <a href="https://bgerber123.github.io/FW670/">https://bgerber123.github.io/FW670/</a>

- **Homework, Discussion Posts, Quizzes, and Grading: **
  - <a href="https://colostate.instructure.com/courses/228738">https://colostate.instructure.com/courses/228738</a>

## 

### 

![Question Mark](/img/question.png){fig-align="center" width="200"}
...
![RStudio 4 panels](/img/rstudio.png){width="95%" fig-align="center"}
...
![Question Mark](/img/question.png){fig-align="center" width="300"}
