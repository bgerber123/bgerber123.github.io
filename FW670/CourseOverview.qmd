...
**Course Number:** FW670 (Experimental Course)
...
**Prerequisites:**  A basic statistics course is required. Being comfortable coding in the R programming language. See [here](/FW670/Rknowledge.qmd) for the type of R knowledge I am expecting. For learning R, see [R resources under 'Learning R' tab](/FW670/)).
