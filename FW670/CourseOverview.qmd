...
**Fall 2026:** M 11am - 12:15 and Fr 10am - 1pm

**Credits:** 3

**Websites:**  [bgerber123.github.io/FW670/](/FW670/index.qmd) (lecture and lab materials) and [Canvas](https://colostate.instructure.com/) (Quizzes, Discussion, Lab Submissions, and Grading).

**Schedule:** [Subject to Change](/FW670/schedule.qmd)

**Prerequisites:**  1) A basic graduate-level statistics course, and 2) being comfortable coding in the R programming language. See [here](/FW670/Rknowledge.qmd) for the type of R knowledge I am expecting. For learning R, see [R resources under 'Learning R' tab](/FW670/)).
...
Students will gain knowledge and skills focused on 1) modeling data to make inference/predictions on wildlife and their habitat, 2) understanding and communicating statistical results, 3) evaluating modeling frameworks based on data and study goals, and 4) implementing models and report writing through the R programming language. The format will include lectures, discussions, in-class labs, out of class assigned labs, and readings. 
...
**In-class lectures:** Most class periods will include a lecture that will vary in length and incorporate instructor-led questions and short discussions.
