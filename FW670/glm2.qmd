...
<!-- knitr::purl("./FW670/glm2.qmd", output="./FW670/glm2.R") -->
...
#### <span style="color:purple">AIC</span>
...
::: {.fragment}
Plot size ($\textbf{A}$) needs to be controlled for. But, we don't want to estimate an effect as it's part of the design. Rather, we want to model our data as a **rate** - counts per unit area.
:::
