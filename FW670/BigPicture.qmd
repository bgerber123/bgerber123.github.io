...
To understand the space-use of coyotes because ....
...
- $\textbf{y}$ is a random vector that has $n$ random values One sample of 4 cells. 
...
rdu<-function(n,lower,upper){sample(lower:upper,n,replace=TRUE)}
