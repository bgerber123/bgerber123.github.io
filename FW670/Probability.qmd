...
<!-- knitr::purl("./FW670/probability.qmd", output="./FW670/probability.R") -->
...
## Frequency / Probabilities {.scrollable}
...
hist(y, xlim=c(0,25),breaks = seq(from=0, to=25, by = 1),main=main,xlab="y / Counts of plants in a plot")
```
...
2.   $y \in  \{0,1, 2\}$ 
      - 0 = site unoccupied
      - 1 = site occupied w/o young
      - 2 = site occupied with young
...
::: {.fragment}
$$
f(y|\theta) = [y|\theta] = 0.2^{1}\times(1-0.2)^{1-1} 
$$
:::
...
<p style="text-align:center"> <span style="color:blue">Are they the same?</span></p>
...
2. <span style="color:blue">Beta</span>:   $y \in  [0,1]$ or $(0,1)$ 
...
Note: [watch the equal sign and check the function!](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/GammaDist.html)
