...
<!-- knitr::purl("./FW670/regression.qmd", output="./FW670/regression.R") -->
...
## Confidence Intervals {.scrollable}
#### Normal Approximation

Assume the sampling distribution of the parameter is Normal
...
Instead of relying on the 95% intervals from an assumed normal/t distribution, we will create an empirical  distribution by resampling our data.
...
![](/img/pdog.png){fig-align="center" width="40%" height="40%"}
