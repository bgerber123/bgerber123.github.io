...
- [Convenient sampling]{style="color:cornflowerblue"} - results when most convenient units are chosen
...
- [Probability sampling]{style="color:cornflowerblue"} - based on a designed process that the probability a unitm is selected is known 
...
- [transects]{style="color:cornflowerblue"} - straight-line segments 
...
::: {.r-fit-text}
 - Trees of sufficient size for spotted owls to use for nesting
 ...
 - Surveys, e.g., number of people that
    - bird watch
    - hunt or fish
    - think wolves should live in Colorado
...
Expectations are an "average" taken over all possible samples of size n.
...
[Is our estimator biased?]{style="color:cornflowerblue"}
...
E.g., The intervewier effect
  - In Aspen, CO, human black bear conflicts tend to be under-reported
  - In New Jersey, they tend to be over-reported
  - Depends on social constructs and attitudes towards wildlife
