...
[Work on problem together]{style="color:#9D00FF;"} **OR** [more about sample sizes]{style="color:#5CE65C;"}?



## [NHT Paradigm]{style="color:#078BCD;"}{.scrollable}
...
## [Statistical Power]{style="color:#078BCD;"}
...
## [Power Analysis]{style="color:#078BCD;"}
...
## [Type II Error / Power]{style="color:#078BCD;"}
...
## [Case Study (R Code)]{style="color:#078BCD;"}
...
## [Tradeoff (Power vs N)]{style="color:#078BCD;"} {.scrollable}
...
## [Truth?]{style="color:#078BCD;"} {.scrollable}
...
## [Tradeoffs]{style="color:#078BCD;"} {.scrollable}
