...
## [Random Response Model]{style="color:#078BCD;"}
...
- Start with a deck of identical notecards except some fraction ($\theta$; this has to be known) is marked
with $A$ and the remaining $(1- \theta)$ is marked with $B$.
...
- A sample of people are chosen and each is asked to randomly draw a card and state ‘yes’ if they agree with the letter on the card or ‘no’ otherwise. 
...
- whether your phone number ends with an odd or even number
