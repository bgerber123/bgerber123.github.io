...
Students will be asked to give a short and punchy oral presentation following the [Ignite Talk format](https://www.ignitetalks.io/) (5 min, 20 slides, slides advance automatically every 15 seconds). The topic is up to the student but focus needs to be on the ideas of sampling discussed in FW552. The talk should go beyond summarizing a sampling process and contribute some new evaluation, assessment, or consideration. Grading will be done by your peers and the instructor via a [standardized rubric](../classfiles552/Presentation Rubric.docx). 
