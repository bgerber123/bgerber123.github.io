...
Create a markdown that accomplishes the assignment tasks below. Make sure to use text to describe each of the things that are requested. 
...
-   Plot the predicted mean bird count trend along with 90\% credible intervals. Add the observed bird count data to these plots (i.e., y).
