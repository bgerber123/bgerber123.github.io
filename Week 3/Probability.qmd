...
$y$ is a random variable which may change values each observation; it changes based on a probability function, $f(y)$. Which value is observed is predictable.
...
- <span style="color:blue">proportion of the population that is X</span> 

. . .


which we make based on our sample (i.e., statistical inference). 
...
$$ 
\hspace{-12pt}f \\
y \Longrightarrow\fbox{DO STUFF
} \Longrightarrow f(y)
$$ 
...
The letter $y$ is arbitrary, based on convention. Could have used any placeholder.
...
<span style="color:red">Probability</span>: Interested in $y$,
$$
\begin{align*}
...
Special functions with rules to guarantee our logic of probabilities are maintained. [Assigned Reading. ](https://medium.com/@srowen/common-probability-distributions-347e6b945ce4)
...
List of PDF for continous supported RVs. <br>
...
4. <span style="color:blue">Poisson</span>:   $y \in  \mathbb{N}_{0}$ (All Integers, starting at 0) 
...
We want to find the joint probability of our data with shared parameters $\mu$ and $\sigma$,
