...
-   Readings for next class:
    - <a href="/readings/Miller et al 2019.pdf">Miller et al 2019</a>

- Background Reading (not required):
  - <a href="/readings/Miller et al 2013.pdf">Miller et al 2013</a>
...
-   Small Group Discussion: fundamental premise of the sampling and modeling using 'Distance Sampling'
...
```{r, eval=FALSE, echo=TRUE}
# CRAN packages
install.packages(c("secr","Distance"))
```
