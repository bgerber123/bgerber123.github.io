...
Here, the goal is to replicate the above 4 analyses (2 data sets and 2 priors) using JAGS via the r pacakge 'rjags'.

To do this, you will need to setup a model.jags file that has the likelihood and prior. Note, that the probability density funcitons in JAGS for Gamma and Poisson are dgamma, and dpois, respectively.
