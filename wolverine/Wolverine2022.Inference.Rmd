...
- *meanNDVI_2022*: The mean NDVI by cell over years X-X. 
...
- *ClusterCount*: Predicted connectivity of cells (function in ArcGIS); ask Jake. Increasing values are hypothesized to increase occupancy, probably up to some point. 
