...
The spatial occupancy was refit to the 2017 wolverine survey data. This was done for two primary reasons:
...
In the refit model, we can see more spatial variation in occurrence by neighboring cells. This is because the spatial variation is being more appropriately estimated. 
...
- Habitat covariate changed from Copland to Copland_Inman.
