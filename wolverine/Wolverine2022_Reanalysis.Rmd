...
2. Additional surveyed cells in Washington; all non-detections

3.  Added the Copeland_Inman habitat covariate on occupancy to make it similar to the model fit to the 2017 survey data.

4. Added bait/lure covariate on detection probability

5. Based on findings from refitting the spatial occupancy model to the 2017 survey data, this model needed to be refit using 
...
knitr::kable(data.frame(State=c("Utah","Colorado","Wyoming","Idaho","Oregon", "Montana","Washington"),
          "2.5%" =c(0,0,44,74,0,42,10),
          "50%" =c(0,0,58,92,0,66,27),
          "97.5%" =c(1,1,76,117,1,102,54)),format = "html",table.attr = "style='width:50%;'",align = "c")
```
...
knitr::kable(data.frame(State=c("Utah","Colorado","Wyoming","Idaho","Oregon", "Montana","Washington"),
          ...
          "50%" =c(0.00,0.00,0.35,0.46,0.00,0.35,0.29),
          "97.5%" =c(0.01,0.01,0.46,0.59,0.01,0.54,0.58)),format = "html",table.attr = "style='width:50%;'",align = "c")
```
