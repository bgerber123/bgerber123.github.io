...
<span style="color:purple">1. What to do next: Consider randomizing a selection of sites that went from Bait-->Lure to be sampled using bait in the third survey. If there a detection method effect we should expect a high proportion of these sites to become occupied or occupied at a higher rate than othere Bait-->Lure sites that continued to be a lure site in the third survey. </span>


<span style="color:purple">2. What to do next: Either include this analyses in the 2nd manuscript as evidence of the concern. Or, present the concern in the discussion logically without the analysis. The later is my preference to keep the manuscript from getting too overwhelming. Note that we have at least partly ameliorated the effect issue of detection method by including bait/lure covariate on the detection probability in the 2017 and 2022 analyses. Because of this change, the difference in occupancy across the years is less than it is when not including it. We can not mix the detection method concern on occupancy, but we can discuss it in the manuscript without this analysis presented above.  </span>
