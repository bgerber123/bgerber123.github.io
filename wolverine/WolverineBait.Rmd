...
This point is captured by Justin Gude: "Our ability to disentangle the effect on detection probability of using baited versus scent-pump only sites is hampered by different site type selection methods among states. Washington and Montana switched from largely baited sites in 2017 (other than inaccessible sites) to exclusively scent-pump only sites in 2022. Idaho and Wyoming used both types of sites in both surveys. However, the use of baited sites in these states was in order to collect genetic material, so they placed these sites in areas known to previously and consistently contain wolverines, to maximize success in collecting genetic material. So wolverine detection probability at these baited sites in 2022 may have inherently been higher."
