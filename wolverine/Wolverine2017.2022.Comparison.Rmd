...
Below I summed the latent state occupancy (z) for all sites/cells within the shared sampling frame to derive a probability distribution of the total number of occupied sites (left plot) and the overall probability of occupancy (right plot) for each survey.
