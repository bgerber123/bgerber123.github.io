...
Here is a plot of the occupancy partial intercepts for the different mountain ranges (Grouping1 variable) and slope coefficent for the Copelan_Inman habitat variable; they are all well converged. 
