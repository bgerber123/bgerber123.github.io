...
### **Markdown**
Create a markdown file that analyses the provided elephant data, accomplishing the below requests:

-   Visualize your data

-   Use the `glm` function and estimate a single $\mu$ and $\sigma$. Interpret test statistics and p-values.

-   Use the `glm` function to estimate the difference of elephant weight by sex. Interpret coefficient estimates and p-values. 
...
-   Fit a new model to estimate site-level variation in elephant weights. Estimate and interpret coefficients and p-values.

- Fit the same model but use effect coding (see links above). Interpret the estimates and p-values. 
