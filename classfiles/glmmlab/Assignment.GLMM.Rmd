...
### **Objective**
Create a report using Markdown that presents code, results, and summarized findings that makes inference to the occurrence of the Annamite striped rabbit (*Nesolagus timminsi*) across multiple protected areas in Vietnam.
...
### **Overview**
The Annamite striped rabbit is a forest-dwelling lagomorph that was recognized as a new species in the mid-1990s. Little is known about this species. What has been done indicates that hunting pressure is a primary driver of its distribution. As such, protected areas are paramount to their conservation. However, protected areas vary in their effectiveness in limiting hunting and some protected areas are founded on multi-use, such that hunting is allowed. 
