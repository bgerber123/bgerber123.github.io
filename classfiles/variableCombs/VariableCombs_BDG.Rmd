...
dat$age.years.sc = scale(dat$age.years,center=TRUE, scale=FALSE)
summary(glm(weight~age.years.sc*site,data=dat))
```
...
### 6. Is this a statement about data or the parameters? 
...
<b><span style="color:purple"> It is a statement about the data. If we know what $\theta$ is than it is the probability of observing the data ($\textbf{y}$), given $\theta$. If we do not know what $\theta$ is than it is likelihood of observing the data ($\textbf{y}$), given our guess of $\theta$.
</span></b>

### 7. Would you like your statistical analysis make a statement about your data or about the parameters?

<b><span style="color:purple"> I personally want to know about the probability of an unknown parameter, given the data we observe because it is the reason why I am fitting a model to data. I can learn about parameters either way, but the parameters is my focus and quantity of interest, so I'd rather make statements directly about them.
</span></b>
