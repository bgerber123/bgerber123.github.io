...
### **Objective**: Create a report using Markdown that presents code, results, and summarized findings that evaluates a hypothesis regarding the occurrence of lynx (*Lynx canadensis*) in the southern Rocky Mountains.
...
- indicate how you used AI to accomplish this lab
