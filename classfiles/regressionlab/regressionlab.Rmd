...
- Explore/present the data; use plots/histograms. Make summary (short) comments on what you see that is important
- Write model notation or use equatiomatic
