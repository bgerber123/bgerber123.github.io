...
First, we know the intercept doesn't mean anything. The effect of forest coeficient is positive and indicates that selection increases with forest cover during the day time (i.e., not night). The `todnight` covariate indicates selection at a forest cover of zero during the night. Since this coeficient is negative, we know that deer are avoding these areas open areas during the day. Both those coeficients are statistically clear. The interaction is not statistically clear, and thus there is no difference of selection at night for increasing foret cover.
