...
### <span style="color:#414487FF">Prey and habitat limitations of Canada Lynx in Colorado</span>

**Objective** To estimate snowshow hare density and forest characteristics in lynx habitat and predicted but not used habitat in Colorado. 

**Team**: Holly Hermanson (CSU), Jake Ivan (Colorado Parks and Wildlife), and Brian Gerber (USGS CRU / CSU).


### <span style="color:#414487FF">Mesocarnivore distributions in Colorado</span>

**Objective** To estimate the distribution  and habitat use of poorly known species in Colorado, including rintails, fox,a and skunk. 

**Team**: Jess Burr (CSU), Jake Ivan (Colorado Parks and Wildlife), and Brian Gerber (USGS CRU / CSU).

----

### <span style="color:#414487FF">Developing and evaluating AI workflows to classify age/sex of ungulates from aerial imagery</span>

**Objective** To improve age and sex estimates of mule deer and elk used to inform population monitoring and harvest. 

**Team**: Taylor Beach (CSU), Mat Allredge (Colorado Parks and Wildlife), Rachel Smiley, and Brian Gerber (USGS CRU / CSU).

----


### <span style="color:#414487FF">Multi-state occurence monitoring of wolverine (Gulo gulo)</span>

**Objective** To survey for wolverine across the western U.S. and Canada to monitor changes in distribution. 

**Team**: Western Association of Fish and Wildlife Agencies (WAFWA) Forest Carnivore Monitoring Group; Brian Gerber (USGS CRU / CSU) is the statistical ecologist.
...
**Team**: Brian Gerber (USGS CRU / CSU), Mason Fidino (Lincoln Park Zoo), Kadambari Devarajan, Zach Farris (Appalachian State Unveristy), and many more.
