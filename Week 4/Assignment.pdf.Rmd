...
### **Markdown**
Create a markdown file that shows and discusses 2 probability functions. An example is provided below as a guide. Which probability function to choose? Lots of options from [wikipedia](https://en.wikipedia.org/wiki/List_of_probability_distributions).
