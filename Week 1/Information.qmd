...
<span style="color:blue">Fisher Information</span>
...
Let's find the joint probability of our data, or the likelihood of a parameter, given our data.
...
Let's combine 1 observation of our random variable, our probability function, and $\theta$ to quantify the Fisher information:
...
-   what parameter we want to estimate and the proability function
-   the goal of the question
:::
